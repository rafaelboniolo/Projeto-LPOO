...
public class BuscaClienteView extends javax.swing.JFrame {
    ...
    public BuscaClienteView() {
            ...
            this.modeloTabelaCliente = new DefaultTableModel(null, new String[]{"Nome, CPF, RG"});

            this.jTable1.setModel(modeloTabelaCliente);
    ...
    private void updateTable(){
        ...
        new PacienteController().buscarTodos().forEach((a)->{
            Paciente p = (Paciente) a;
            this.modeloTabelaCliente.addRow(new Object[]{p.getNome(),p.getCpf(),p.getRg()});
        });
