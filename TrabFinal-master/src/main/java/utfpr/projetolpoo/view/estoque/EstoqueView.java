...
public class EstoqueView extends javax.swing.JInternalFrame {
    ...
    DefaultTableModel modeloTabelaVendas;
    ...
    public EstoqueView(JDesktopPane jdesktopPane)  {
        ...
        this.modeloTabelaEstoque = new DefaultTableModel(null, new String[]{"Codigo", "Nome", "Valor", "Qtd"});
        this.modeloTabelaVendas = new DefaultTableModel(null, new String[]{"Codigo", "Nome", "Valor", "Qtd"});
        
        this.jTable1.setModel(modeloTabelaEstoque);
        this.jTable2.setModel(modeloTabelaVendas);
    ...
    private void initComponents() {
        ...
        jButton5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/if_Erase_105247.png"))); // NOI18N
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        this.modeloTabelaVendas.addRow(new Object[]{p.getCodigo(), p.getNome(), p.getValor(), p.getQuantidade()});
    ...
    private void updateTable(){
        ...
        new ProdutoController().buscarTodos().forEach((a)->{
            Produto p = (Produto) a;
            this.modeloTabelaEstoque.addRow(new Object[]{p.getCodigo(),p.getNome(),p.getValor(),p.getQuantidade()});
        });
